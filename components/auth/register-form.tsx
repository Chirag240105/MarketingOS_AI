    ...
    <div className="w-full max-w-md">
      ...
      <form action={formAction} className="mt-8 space-y-4">
        <label className="block text-sm text-slate-300">
          Name
          <Input name="name" autoComplete="name" className="mt-2" required />
        </label>
        <label className="block text-sm text-slate-300">
          Work email
          <Input name="email" type="email" autoComplete="email" className="mt-2" required />
        </label>
        <label className="block text-sm text-slate-300">
          Password
          <Input name="password" type="password" autoComplete="new-password" minLength={8} className="mt-2" required />
        </label>
